...
_door_detector = _load_submodule("door_detector.py", "P3_door_detector")
_config = _load_submodule("config.py", "P3_config")

DoorDetector = _door_detector.DoorDetector
DEFAULT_CONFIG = _config.DEFAULT_CONFIG
get_config = _config.get_config

__all__ = ['DoorDetector', 'DEFAULT_CONFIG', 'get_config']
